                    ...
                    <div className="form-group text-secondary px-3 py-2">
                        ...
                        <div className="group d-flex mt-2">
                            ...
                            <button className="addBand col-2 ml-4 rounded" onClick={() => {
                                this.props.handleChange('loc', 'add', this.state.data)
                                this.setState({ data: '' });
                            }}>Add</button>
                        </div>
                    </div>
                ...
                <div className="output p-2">
                    ...
                    <ul className="mt-3 d-flex">
                        {this.props.data.map((loc, index) => {
                            return (
                                <li className="" key={index}><span className="title mr-4">{loc}</span><span className="closer" onClick={() => this.props.handleChange('loc', 'delete', loc)}>X</span></li>
                            );
                        })}
                    </ul>
                </div>
